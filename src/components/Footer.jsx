const Footer = () => {
  return (
    <footer className="footer bg-darkGrey pt-[37px] pb-[60px] tablet:pt-[30px] tablet:pb-[40px] laptop:pt-[47px] laptop:pb-[92px]">
      <h2 className="visuallyhidden">Footer</h2>
      <div className="wrapper">
          <nav className="flex justify-center flex-wrap gap-x-[25px] gap-y-[20px] tablet:justify-normal tablet:items-center tablet:gap-x-8 tablet:gap-y-0">
          <h2 className="visuallyhidden">Navigation</h2>
            <a
              href=""
              className="basis-full text-center text-clampSize leading-8 -tracking-[0.33px] hover:text-greenAccent tablet:-tracking-[0.44px]  tablet:basis-auto tablet:mr-auto   "
            >
              adamkeyes
              <span className="visuallyhidden">(to home page)</span>
            </a>
            <a href="" className="hover:text-greenAccent">
              <svg
